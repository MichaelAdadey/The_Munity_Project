...
import { signInWithGoogleAsTherapist } from "@/app/therapistsignup/actions";
...
function CreateAccountButton() {
  return (
    <Button type="submit" className="h-12 w-full rounded-xl shadow-[0_1px_1px_rgba(0,0,0,0.05)]">
      Create Account
    </Button>
  );
}
...
function AuthField({
  ...
  return (
    <div className="flex flex-col gap-2">
      <label htmlFor={id} className="px-1 text-sm font-semibold tracking-wide text-munity-text">
        {label}
      </label>
