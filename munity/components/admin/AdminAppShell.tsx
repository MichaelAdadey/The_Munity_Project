...
import {
  NotificationsMenu,
  ProfileAvatar,
} from "@/components/live/NotificationsMenu";
...
const adminNav = [
  ...
  {
    label: "Moderator Applications",
    href: routes.adminModeratorApplications,
    icon: UserCheck,
  },
      ...
      <div className="min-h-screen bg-munity-bg">
        ...
        <header className="fixed inset-x-0 top-0 z-50 border-b border-[rgba(197,200,184,0.2)] bg-[rgba(251,249,248,0.8)] shadow-sm backdrop-blur-md lg:left-64">
          <div className="flex h-16 items-center gap-4 px-6 lg:px-10">
            <h1 className="shrink-0 text-xl font-bold text-munity-green md:text-2xl">
              {title}
            </h1>
            {actions ? (
