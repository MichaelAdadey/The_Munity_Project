            ...
            <AnimatedPage className="flex-1">
              <header className="mb-8 flex flex-wrap items-end justify-between gap-4">
                <div>
                  ...
                  <h1 className="mt-2 text-3xl font-bold text-munity-text">Analytics</h1>
                  <p className="mt-1 text-base text-munity-muted">
                    Therapeutic progress across your full patient caseload
                  </p>
                </div>
                  ...
                  >
                    ...
                    <div className="mt-5 grid grid-cols-2 gap-4 lg:grid-cols-4">
                      ...
                      <div className="rounded-2xl border border-munity-border bg-munity-sidebar/30 p-4">
                        ...
                        <p className="mt-2 text-2xl font-bold text-munity-text">
